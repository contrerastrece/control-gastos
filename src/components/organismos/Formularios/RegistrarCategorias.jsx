...
import { BtnSave, InputText, Spiner, useCategoriesStore, useOperation, useUsuariosStore }from '../../../index'
  ...
  const insertar=async(data)=>{
    if(accion==='Editar'){
      const p = {
        ...
        icono: emojiselect,
        id: dataSelect.id,
        id_user:datausuarios.id,
        type: type,
      };

      try {
        setEstadoproceso(true)
        await updateCategories(p)
